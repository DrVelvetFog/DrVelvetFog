...
**8 pull requests merged into repos I don't own, across 5 organisations** — someone else's maintainer decided each one was worth carrying:
...
Open and in review: a release run-ledger binding build artifacts to their gate decisions in openmed ([#1899](https://github.com/maziyarpanahi/openmed/pull/1899)).
